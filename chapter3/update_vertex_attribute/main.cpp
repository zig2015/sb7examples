...
public:
    virtual void startup() {
        const char* vertex_shader_path = "../chapter3/update_vertex_attribute/vertex.glsl";
        const char* fragment_shader_path = "../chapter3/update_vertex_attribute/fragment.glsl";
    ...
    virtual void render(double currentTime) {
        ...
        GLfloat attrib[] = { (float)sin(currentTime)*0.5f, (float)sin(currentTime)*0.6f, 0.0f, 0.0f };
