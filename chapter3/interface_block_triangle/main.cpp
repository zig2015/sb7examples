...
public:
    virtual void startup() {
        const char* vertex_shader_path = "../chapter3/interface_block_triangle/vertex.glsl";
        const char* fragment_shader_path = "../chapter3/interface_block_triangle/fragment.glsl";
